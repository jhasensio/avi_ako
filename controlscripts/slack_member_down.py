...
if __name__ == "__main__":
  ...
  message=("GS_MEMBER_DOWN: The service "+obj_uuid+" at the IP Address *"+gs_member_ip_add+"* is no longer available for the GSLB service *"+gslb_service+"* that is part of the group "+gs_group+".")
  message_slack={
                 "text": "Alarm message from AVI NSX ALB",
                 "color": "#FF0000", 
                 "fields": [{
                 "title": "GS_MEMBER_DOWN",
                 "value": "The service "+obj_uuid+" at the IP Address *"+gs_member_ip_add+"* is no longer available for the GSLB service *"+gslb_service+"* that is part of the group "+gs_group+".",
                }]}
